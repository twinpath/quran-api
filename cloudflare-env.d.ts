/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv ./cloudflare-env.d.ts` (hash: 8f860123a0ea9e77f254862e611cbcee)
// Runtime types generated with workerd@1.20260811.1 2026-08-15 global_fetch_strictly_public
interface __BaseEnv_CloudflareEnv {
	IMAGES: ImagesBinding;
	ASSETS: Fetcher;
	NEXTJS_ENV: string;
	WORKER_SELF_REFERENCE: Fetcher /* quran-json */;
}
