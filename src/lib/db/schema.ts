...
export const user = sqliteTable(
  "user",
  {
    ...
    usageAlertsEnabled: integer("usage_alerts_enabled", { mode: "boolean" }).notNull().default(true),
    emailNotificationsEnabled: integer("email_notifications_enabled", { mode: "boolean" }).notNull().default(true),
    createdAt: integer("created_at", { mode: "timestamp" }).notNull(),
