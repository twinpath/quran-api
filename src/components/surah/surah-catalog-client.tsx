...
export function SurahCatalogClient({ initialSurahs, isLoading }: SurahCatalogClientProps) {
  const {
    query,
    setQuery,
    revelationFilter,
  ...
  const displaySurahs = isLoading || filteredSurahs.length === 0 && initialSurahs.length === 0
