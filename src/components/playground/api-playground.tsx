...
export function ApiPlayground({ isLoading }: LoadingProps = {}) {
  const {
    state,
    selectedEndpoint,
    endpoints,
    ...
    <section id="api-playground" className="scroll-mt-20 mx-auto max-w-6xl px-4 py-12 sm:px-6">
      <div className="mb-8 text-center">
        <div className="font-heading text-3xl font-bold tracking-tight sm:text-4xl">
          {isLoading ? <Skeleton className="mx-auto mb-2 h-9 w-64" /> : <h1>API Playground</h1>}
        </div>
      ...
      <div className="border border-border bg-card shadow-sm">
        ...
        <div className="border-b border-border p-4">
          ...
          <div className="mt-3 text-sm text-muted-foreground">
            {isLoading ? <Skeleton className="h-4 w-72" /> : selectedEndpoint.description}
          </div>
        </div>
              ...
              <Tabs defaultValue="response" className="w-full">
                ...
                <TabsContent value="response" className="mt-4">
                  {state.response ? (
                    ...
                    <div className="flex h-48 items-center justify-center border border-dashed border-border text-sm text-muted-foreground">
